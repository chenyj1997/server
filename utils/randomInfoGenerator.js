...
const lastNamesSingle = [
    "芳", "娜", "敏", "静", "丽", "娟", "秀", "霞", "桂", "丹", "涵", "梦", "妍", "思", "彤", "娣", "昭", "娅", "楠", "嫦", "娥", "姚", "红", "艳", "慧", "玉", "根", "梁", "珏", "青", "玉", "岚", "媚", "黎", "芹", "雁", "蓉", "捷", "鳕", "鬽", "俪", "勤", "柳", "茹", "颉", "玲", "霞", "倩", "婷"
];

const lastNamesDouble = [
    "子涵", "雨萱", "梓涵", "欣怡", "依诺", "雨涵", "诗涵", "嘉怡", "若曦", "语桐", "思远", "晨曦", "梦琪", "欣妍", "思彤", "可馨", "佳琪", "思睿", "文昊", "思怡", "雅静", "雅丽", "雅芳", "雅琴", "雅慧", "雅娜", "雅红", "雅敏", "雅丽", "雅娟", "雅秀", "雅霞", "雅丹", "雅英", "雅玉", "雅琴", "雅慧", "雅芳", "雅娜", "雅静", "雅红", "雅敏", "雪梅", "玉梅", "春燕", "秋霞", "玉珍", "美玲", "美华", "美丽", "玉华", "美珍", "美娟", "玉英", "美兰", "娟霞", "美琴", "玉慧", "美芳", "美娜", "美静", "美红", "美敏", "美丽", "美娟", "玉秀", "美霞", "姜丹", "美英", "美玉", "美琴", "美慧", "岚芳", "岚娜", "岚静", "美红", "秀敏"
];
